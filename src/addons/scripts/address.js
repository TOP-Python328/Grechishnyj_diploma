...
async function main(){
    ...
    addressBlocks.forEach(addressBlock => {
        const selectRegion = addressBlock.querySelector('select[name="region"]');
        const selectDistrict = addressBlock.querySelector('select[name="district"]');
        const selectCity = addressBlock.querySelector('select[name="city"]');
